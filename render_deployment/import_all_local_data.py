#!/usr/bin/env python3
"""
Import ALL local data into Render deployment
This script imports users, categories, and ALL habits from local export
"""
...
# ALL your local habits - this includes the 187 habits from your export
ALL_HABITS_DATA = [
    # Shruti's habits (from your local data)
